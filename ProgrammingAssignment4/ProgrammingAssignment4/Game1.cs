...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            teddy = new TeddyBear(teddySprite, center);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (mouse.RightButton == ButtonState.Released)
            {
                ...
                if (rightClickStarted)
                {
                    ...
                    Pickup pickup = new Pickup(pickupSprite, mouseLocation);
                    pickups.Add(pickup);
                ...
                teddy.CollisionRectangle.Intersects(pickups[0].CollisionRectangle))
            {
                ...
                if (pickups.Count != 0)
                {
                    Vector2 pickupLocation = new Vector2(pickups[0].CollisionRectangle.X, pickups[0].CollisionRectangle.Y);
