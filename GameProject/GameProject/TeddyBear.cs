    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                firingDelay = GetRandomFiringDelay();
                Projectile newProj = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear),
                    drawRectangle.Center.X, drawRectangle.Center.Y - GameConstants.TeddyBearProjectileOffset, -GameConstants.TeddyBearProjectileSpeed);

                Game1.AddProjectile(newProj);
                shootSound.Play();
            }
